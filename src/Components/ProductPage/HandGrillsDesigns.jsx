      ...
      <Carousel>
          <Carousel.Item>
           ...
           <Carousel.Caption style={{color:'orange',width:'400px',height:'200px',backgroundColor:'white'}}>
              <h3 style={{fontSize:'50px'}}><b>HAND GRILLS </b> DESIGNS</h3>
...
We are able to fabricate the complete staircase with a combination of materials including steel, glass, acrylic and timber. We are engaged in offering exclusive Balcony Railing Design to the clients.
We are manufacturing all the products using high-grade components and modern techniques under the surveillance of our
<br/>seasoned team of highly experienced professionals.
<br/>Railing Design is rigidly checked on several parameters of quality.
      </p>
      <span>
        <Container>
      <Row>
